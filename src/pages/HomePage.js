        ...
        <nav class="nav w-full fixed bg-[#fdfdfd]  border-gray-200 dark:bg-gray-900 text-[20px]">
          <div class="max-w-screen-xl  flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center">
              <img src="https://res.cloudinary.com/dfbjxzinc/image/upload/v1686511926/Elegant_White_and_Black_Real_Estate_Agent_Logo_sjqbja.png"
                class="w-[80px] h-[40px] " alt="Flowbite Logo" />
              <span class="self-center text-2xl font-semibold whitespace-nowrap ">Thang</span>
            </a>
